...
namespace ServiceStack.OrmLite.SqlServer
{
    public class SqlServerOrmLiteDialectProvider : OrmLiteDialectProviderBase<SqlServerOrmLiteDialectProvider>
    {
        ...
        public SqlServerOrmLiteDialectProvider()
        {
            ...
            base.DecimalColumnDefinition = "DECIMAL";
        ...
        public override string GetColumnDefinition(string fieldName, Type fieldType, bool isPrimaryKey, bool autoIncrement, bool isNullable, int? fieldLength, int? scale, string defaultValue)
        {
            ...
            {
                fieldDefinition = string.Format("{0} ({1},{2})", this.DecimalColumnDefinition, fieldLength.GetValueOrDefault(base.DefaultDecimalPrecision), scale.GetValueOrDefault(base.DefaultDecimalScale));
